...
Qora's components are written in Svelte and compiled/wrapped into other formats.
...
preferred component from `@QorAI/qora/react/button` instead of `@QorAI/qora/react/button/button`.
...
```html
<!-- Plain HTML -->
<qora-my-cool-component greeting="Kia ora">NZ</qora-my-cool-component>
<script type="module">
