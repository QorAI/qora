...
<div class="qora-alert-center" {style}>
...
<style lang="scss">
  .qora-alert-center {
    --width: var(--qora-alert-center-width, min(540px, 100vw));
    z-index: var(--qora-alert-center-z-index, 1000);
    position: var(--qora-alert-center-position, fixed);
    width: var(--width);
