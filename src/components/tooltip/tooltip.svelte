...
<style lang="scss">
  ...
  .qora-tooltip {
    --background: var(
      --qora-tooltip-background,
      var(--qora-color-container-background)
    );
    --text: var(--qora-tooltip-text-color, var(--qora-color-text-primary));
    --shadow: var(--qora-tooltip-shadow, var(--qora-effect-elevation-03));
    --padding: var(--qora-tooltip-padding, var(--qora-spacing-xl));
    --radius: var(--qora-radius-m);
  ...
  .qora-tooltip .tooltip.hero {
    --background: var(--qora-gradient-hero);
    --text: var(--qora-color-container-background);
  }

  .qora-tooltip .tooltip.info {
    --background: var(--qora-color-button-background);
    --text: var(--qora-color-container-background);
  }

  .qora-tooltip .tooltip.mini {
    --background: var(--qora-color-neutral-60);

    --text: var(--qora-color-neutral-10);
    --padding: var(--qora-spacing-m);
    --shadow: var(--qora-effect-elevation-01);
    --radius: var(--qora-radius-s);

    font: var(--qora-font-x-small-regular);
  }

  .qora-tooltip .tooltip.default {
    --border-color: var(--qora-color-divider-subtle);
    --border-width: 1px;
  }
</style>
