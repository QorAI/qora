...
<Template let:args>
  <div class="container">
    <ButtonMenu>
      ...
      <qora-menu-item on:click={handleAction}> Copy </qora-menu-item>
      <qora-menu-item> Share </qora-menu-item>
      <qora-title> 
        Section title here 
      </qora-title>
      <qora-menu-item>
...
<!-- TODO(petemill): We should probably only allow qora-menu-item for ButtonMenu, otherwise it gets complicated about event dispatching. Alternatively, we
  ...
  <SlotInfo description="">
    <Slot name="default" explanation="The menu items">
      <p>
        ...
        &lt;qora-menu-item&gt; and &lt;qora-option&gt; elements as well as any
        other element types.
      </p>
      <ul>
        <li>
          Use &lt;qora-menu-item&gt; for menu-style commands and
          &lt;qora-option&gt; for select-style selectable choices.
        </li>
        <li>
