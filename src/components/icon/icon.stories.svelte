  ...
  export const meta = {
    ...
    argTypes: {
      ...
      color: {
        control: 'color',
        description:
          'The current text color (this is used for the icon if --qora-icon-color is not set)',
        type: 'string'
      }
    },
    args: {
      color: 'var(--qora-color-icon-default)',
...
<Story name="Slots" let:args>
  <SlotInfo
    description="The icon has a single slot for specifying a custom icon, while retaining the Qora Icon styling"
  >
    <Slot
      name="default"
