...
<style lang="scss">
  .qoraIcon {
    --icon-width: var(--qora-icon-width, var(--qora-icon-size, 24px));
    --icon-height: var(--qora-icon-height, var(--qora-icon-size, 24px));
    --icon-color: var(--qora-icon-color, currentColor);
